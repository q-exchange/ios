...
//灰色
#define kGrayColor QDThemeManager.currentTheme.themeMainTextColor
...
- (void)setupTitleLabel:(NSString *)titleStr{
    ...
    UIColor *textColor = self.titleLabTextColor ? self.titleLabTextColor : QDThemeManager.currentTheme.themeMainTextColor;
    CGFloat width = [self returnTextWidth:titleStr size:CGSizeMake(contentMaxWidth, fontSize) font:font].width;
    //
    self.titleLabel.frame = CGRectMake(0, contentHeight + 10, width, fontSize);
...
- (void)setupDetailLabel:(NSString *)detailStr{
    ...
    UIColor *textColor = self.detailLabTextColor ? self.detailLabTextColor : QDThemeManager.currentTheme.themeDescriptionTextColor;
...
- (void)setupActionBtn:(NSString *)btnTitle target:(id)target action:(SEL)action btnClickBlock:(LYActionTapBlock)btnClickBlock{
    ...
    CGFloat fontSize = font.pointSize;
    UIColor *titleColor = self.actionBtnTitleColor ? self.actionBtnTitleColor : QDThemeManager.currentTheme.themeMainTextColor;
