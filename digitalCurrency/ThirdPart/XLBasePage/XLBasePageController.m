...
-(UIScrollView *)titleBackground
{
    if (!_titleBGScroll) {
        ...
        _titleBGScroll.backgroundColor = QDThemeManager.currentTheme.themeBackgroundColor;
        _titleBGScroll.showsHorizontalScrollIndicator = NO;
        _titleBGScroll.showsVerticalScrollIndicator = NO;
        sep = [[UIView alloc] init];
        sep.backgroundColor = QDThemeManager.currentTheme.themeSeparatorColor;
        [_titleBGScroll addSubview:sep];
        
        line = [[UIView alloc] init];
        [_titleBGScroll addSubview:line];
        line.backgroundColor = QDThemeManager.currentTheme.themeSelectedTitleColor;
    }
...
-(void)viewDidLayoutSubviews
{
    ...
    sep.frame = CGRectMake(0, _titleBGScroll.frame.size.height - 1, _titleBGScroll.frame.size.width, 1);
