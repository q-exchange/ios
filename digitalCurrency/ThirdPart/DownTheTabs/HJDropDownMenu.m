...
#define dropBackColor  QDThemeManager.currentTheme.themeBackgroundDescriptionColor//RGBOF(0x1F2833)
...
- (void)configData{
    ...
    self.indicatorColor = QDThemeManager.currentTheme.themeMainTextColor;
    
    self.textColor = QDThemeManager.currentTheme.themeMainTextColor;
