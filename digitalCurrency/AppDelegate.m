...
//    [NSThread sleepForTimeInterval:1];
    ...
    self.window.backgroundColor = QDThemeManager.currentTheme.themeBackgroundColor;
...
- (void)initQMUI{
    ...
    NSLog(@"identifier --- %@",[[NSUserDefaults standardUserDefaults] objectForKey:QDSelectedThemeIdentifier]);
