...
-(void)RightsetupNavgationItemWithpictureName:(NSString*)picturename{
    ...
    [backBtn setImage:[UIImage imageNamed:picturename] forState:UIControlStateNormal];
    [backBtn addTarget:self action:@selector(RighttouchEvent) forControlEvents:UIControlEventTouchUpInside];
