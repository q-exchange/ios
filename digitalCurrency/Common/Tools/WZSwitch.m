...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.moveView   = [[UIView alloc]initWithFrame:CGRectMake(0, 0, width, height)];
        self.moveView.layer.cornerRadius    = (height)/2;
        self.moveView.clipsToBounds         = YES;
        self.moveView.backgroundColor       = [UIColor whiteColor];
        self.moveView.layer.borderWidth = 1;
        self.moveView.layer.borderColor = [UIColor whiteColor].CGColor;
