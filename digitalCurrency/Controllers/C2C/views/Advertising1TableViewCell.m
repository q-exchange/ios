...
- (void)awakeFromNib {
    ...
    self.centerTextFileld.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.centerTextFileld.textColor = QDThemeManager.currentTheme.themeMainTextColor;
