...
- (void)awakeFromNib {
    ...
    [self.leftButton setTitleColor:QDThemeManager.currentTheme.themeTitleTextColor forState:UIControlStateNormal];
    [self.rightButton setTitleColor:QDThemeManager.currentTheme.themeTitleTextColor forState:UIControlStateNormal];
