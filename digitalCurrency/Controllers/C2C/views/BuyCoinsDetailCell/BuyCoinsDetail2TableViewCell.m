...
- (void)awakeFromNib {
    ...
    self.tipstring.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.coinType1.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.coinType2.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    
    self.tradTipLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
