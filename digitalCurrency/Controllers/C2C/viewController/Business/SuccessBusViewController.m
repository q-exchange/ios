...
- (void)viewDidLoad {
    ...
    self.namelabel.text = LocalizationKey(@"Yourbusinesscertificationsucess");
    self.titlelabel1.text = LocalizationKey(@"Preparationinformation");
    self.titlelabel2.text = LocalizationKey(@"Submitaudit");
    self.titlelabel3.text = LocalizationKey(@"authenticated");
    [self.Advertisebutton setTitle:LocalizationKey(@"Publishadvertisements") forState:UIControlStateNormal];
...
-(void)advertisingBGView{
    ...
    if (!_adView) {
        ...
        [_adView.cancelButton setTitle:LocalizationKey(@"cancel") forState:UIControlStateNormal];
