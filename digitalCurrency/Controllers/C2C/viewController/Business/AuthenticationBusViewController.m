...
- (void)viewDidLoad {
    ...
    self.Bondlabel.text = LocalizationKey(@"Margincurrency");
    self.BondNumlabel.text = LocalizationKey(@"Quantityofmargin");
    self.personProve.text = LocalizationKey(@"PersonalDigitalAssetCertification");
    self.NumProve.text = LocalizationKey(@"DigitalAssetTransactionCertificate");
    
    self.phoneTF.placeholder = LocalizationKey(@"inputMobile");
    self.wechatTF.placeholder = LocalizationKey(@"inputWeChatNum");
    self.QQTF.placeholder = LocalizationKey(@"PleaseentertheQQ");
