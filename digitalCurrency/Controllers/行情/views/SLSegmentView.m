...
- (void)setNormalColor:(UIColor *)normalColor{
    ...
    for (UIButton *btn in self.segementButtonArray) {
...
- (void)setIndLineColor:(UIColor *)indLineColor{
    _indLineColor = indLineColor;
    self.canSliderLine.backgroundColor = indLineColor;
}
...
- (UIView *)segementContainer
{
    if (!_segementContainer) {
        ...
        _segementContainer.backgroundColor = [UIColor clearColor];
    }
