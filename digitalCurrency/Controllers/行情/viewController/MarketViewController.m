...
//  Copyright © 2018年 TAOBI. All rights reserved.
//
...
- (void)viewDidLoad {
    ...
    self.segmentTitleArray= @[LocalizationKey(@"collect"),@"USDT",@"BTC",@"ETH"];
    [self setUpViews];
...
- (void)handleThemeDidChangeNotification:(NSNotification *)notification {
    self.segment.backgroundColor = [QDThemeManager currentTheme].themeBackgroundColor;
    self.segment.normalColor = [QDThemeManager currentTheme].themeMainTextColor;
    self.segment.selectColor = [QDThemeManager currentTheme].themeSelectedTitleColor;
    self.segment.bottomLineColor = [QDThemeManager currentTheme].themeSeparatorColor;
    self.segment.indLineColor = [QDThemeManager currentTheme].themeSelectedTitleColor;
    
    self.ctrlContanier.backgroundColor = [QDThemeManager currentTheme].themeBackgroundColor;
}
...
- (SLSegmentView *)segment
{
    if (!_segment) {
        ...
        _segment.backgroundColor = [QDThemeManager currentTheme].themeBackgroundColor;
        _segment.normalColor = [QDThemeManager currentTheme].themeMainTextColor;
        _segment.selectColor = [QDThemeManager currentTheme].themeSelectedTitleColor;
        _segment.bottomLineColor = [QDThemeManager currentTheme].themeSeparatorColor;
        _segment.indLineColor = [QDThemeManager currentTheme].themeSelectedTitleColor;
...
-(UIScrollView *)ctrlContanier
{
    if (!_ctrlContanier) {
        ...
        _ctrlContanier.backgroundColor = [QDThemeManager currentTheme].themeBackgroundColor;
