...
@interface AssetsCoinViewController ()<UITableViewDelegate, UITableViewDataSource,QMUITextFieldDelegate>
{
    BOOL _refreshFlag;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        cell.titleLabel.text = [NSString stringWithFormat:@"%@（USDT）", LocalizationKey(@"assert_exchangebalances")];
