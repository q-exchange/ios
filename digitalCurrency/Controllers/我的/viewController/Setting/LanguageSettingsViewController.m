...
- (void)viewDidLoad {
    ...
    self.englishLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.ChineseLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
