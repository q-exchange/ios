...
@property (weak, nonatomic) IBOutlet QMUITextField *IDNumTextField;
...
- (void)viewDidLoad {
    ...
    self.bottomLabel.text = LocalizationKey(@"threeconditions");
...
-(void)makeUI{
    ...
    self.idcardView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundColor;

    self.nameLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.IDNumLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.idcardLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.idcardUpdateLabel.textColor = QDThemeManager.currentTheme.themeMainTextColor;

    self.nameTextField.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.IDNumTextField.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;

    self.nameTextField.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.IDNumTextField.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.reasonTitle.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    ...
    if ([self.identifyStatus isEqualToString:@"1"]) {
        ...
        self.reasonView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundDescriptionColor;
        self.idcardUpdateLabel.text = LocalizationKey(@"Uploaded");
