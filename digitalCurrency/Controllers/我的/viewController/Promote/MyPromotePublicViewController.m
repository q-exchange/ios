...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (self.dataArr.count > 0) {
        if (_index == 0) {
            ...
            time.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
            ...
            count.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_index == 0) {
        ...
        if (indexPath.row % 2) {
            ...
            cell.backView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundDescriptionColor;
        }
...
-(UIView *)PromoteFriendsheader{
    if (!_PromoteFriendsheader) {
        ...
        _PromoteFriendsheader.backgroundColor = QDThemeManager.currentTheme.themeBackgroundDescriptionColor;
        ...
        registerlabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
        ...
        recommendedLevelLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
        ...
        userNameLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
...
-(UIView *)MineNetheader{
    if (!_MineNetheader) {
        ...
        _MineNetheader.backgroundColor = QDThemeManager.currentTheme.themeBackgroundDescriptionColor;
        ...
        remarkLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
        ...
        amountLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
        ...
        coinTypeLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
        ...
        issueTimeLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
