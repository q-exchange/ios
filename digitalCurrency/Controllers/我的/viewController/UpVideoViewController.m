...
- (void)viewDidLoad {
    ...
    self.upImageView.image = [UIImage imageNamed:@"上部分"];
    if ([[ChangeLanguage userLanguage] isEqualToString:@"en"]) {
        self.upImageView.image = [UIImage imageNamed:@"视频认证"];
    }
    ...
    self.uodatavideolabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
