...
@interface MentionMoneyViewController ()<QMUITextFieldDelegate,AddMentionCoinAddressViewControllerDelegate, ZTSearchCoinViewControllerDelegate>
...
@property (weak, nonatomic) IBOutlet QMUITextField *numTextField;//数量中的货币数
@property (weak, nonatomic) IBOutlet UILabel *numCoinType;//数量中的货币类型
@property (weak, nonatomic) IBOutlet UIButton *allButton;//全部按钮
@property (weak, nonatomic) IBOutlet QMUITextField *poundageNum;//手续费
@property (weak, nonatomic) IBOutlet QMUITextField *accountNum;//到账数量
@property (weak, nonatomic) IBOutlet UILabel *accountNumCoinType;//到账数量货币的类型
@property (weak, nonatomic) IBOutlet QMUITextField *moneyPassword;//资金密码
@property (weak, nonatomic) IBOutlet QMUITextField *mobilecodeTF;//手机验证码
...
@property (weak, nonatomic) IBOutlet UILabel *selCoinLabel;
...
//    [self.QrCodeButton setTitle:[[ChangeLanguage bundle] localizedStringForKey:@"addAddress" value:nil table:@"English"] forState:UIControlStateNormal];
    self.mobilecodelabel.text = LocalizationKey(@"phoneValidate");
    self.mobilecodeTF.placeholder = LocalizationKey(@"inputPhoneCode");
    [self.getcodeButton setTitle:LocalizationKey(@"getVerifyCode") forState:UIControlStateNormal];
...
- (void)layoutUI{
    ...
    self.line7.backgroundColor = QDThemeManager.currentTheme.themeSeparatorColor;

    
    self.availableLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.mentionCoinAdddressLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    ...
    self.amountNumLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.moneyPasswordLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.mobilecodelabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;

    self.availableCoinNum.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.availableCoinType.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.numCoinType.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.accountNumCoinType.textColor = QDThemeManager.currentTheme.themeMainTextColor;

    self.numTextField.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.poundageNum.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.accountNum.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.moneyPassword.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.mobilecodeTF.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.mentionMoneyAddress.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    
    self.selView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundDescriptionColor;
    ...
    self.selCoinLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
