...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    headView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundDescriptionColor;
    UILabel *leftLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10,kWindowW-20, 20)];
    leftLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
