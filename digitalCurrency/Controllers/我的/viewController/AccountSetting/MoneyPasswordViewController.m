...
@property (weak, nonatomic) IBOutlet QMUITextField *loginOrOldPassword;//旧密码或登录密码
@property (weak, nonatomic) IBOutlet QMUITextField *moneyPassword;//新密码
@property (weak, nonatomic) IBOutlet QMUITextField *certainPassword;//确认密码
@property (weak, nonatomic) IBOutlet QMUITextField *code;//验证码
...
- (void)viewDidLoad {
    ...
    self.oldPaddOrLoginView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundColor;

    self.codeLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.loginOrOldTitle.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.latestMoneyPasswordLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.certainMoneyPasswordLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.tipLabel.textColor = QDThemeManager.currentTheme.themeMainTextColor;

    self.code.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.loginOrOldPassword.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.moneyPassword.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.certainPassword.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;

    self.code.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.loginOrOldPassword.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.moneyPassword.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.certainPassword.textColor = QDThemeManager.currentTheme.themeMainTextColor;
