...
- (void)viewDidLoad {
    ...
    self.receivePhoneCode.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.unReceivePhoneCode.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.tips.textColor = QDThemeManager.currentTheme.themeMainTextColor;
