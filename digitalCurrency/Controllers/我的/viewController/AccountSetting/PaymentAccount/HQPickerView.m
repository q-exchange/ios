...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self == [super initWithFrame:frame]) {
        ...
        self.bgView.backgroundColor = QDThemeManager.currentTheme.themeBackgroundColor;
        ...
        [self.cancelBtn setTitleColor:QDThemeManager.currentTheme.themeSelectedTitleColor forState:UIControlStateNormal];
        ...
        [self.completionBtn setTitleColor:QDThemeManager.currentTheme.themeSelectedTitleColor forState:UIControlStateNormal];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    for(UIView *singleLine in pickerView.subviews)
    {
        ...
        {
            singleLine.backgroundColor = QDThemeManager.currentTheme.themeSeparatorColor;
        }
    }
    ...
    reasonLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
