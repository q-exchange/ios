...
@property (weak, nonatomic) IBOutlet QMUITextField *aliPayNum;
...
- (void)layoutUI{
    ...
    self.alipayNumLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    ...
    self.aliPayNum.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.moneyPassword.textColor = QDThemeManager.currentTheme.themeMainTextColor;

    self.aliPayNum.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
