...
@property (weak, nonatomic) IBOutlet QMUITextField *weChatNum;
...
- (void)layoutUI{
    ...
    self.collectQRCodeLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.nameLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.weChatNumLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    ...
    self.weChatNum.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.moneyPassword.textColor = QDThemeManager.currentTheme.themeMainTextColor;

    self.weChatNum.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
