...
@property (weak, nonatomic) IBOutlet QMUITextField *latestPhoneNum;
@property (weak, nonatomic) IBOutlet QMUITextField *loginPassword;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bottomViewHeight;
@property (weak, nonatomic) IBOutlet QMUITextField *codeTextField;//短信验证码
// 国际化需要
...
- (void)viewDidLoad {
    ...
    self.latestPhoneNumLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.loginPasswordLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.messageCode.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.tipLabel.textColor = QDThemeManager.currentTheme.themeMainTextColor;

    self.codeTextField.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.latestPhoneNum.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
    self.loginPassword.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;

    self.codeTextField.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.latestPhoneNum.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    self.loginPassword.textColor = QDThemeManager.currentTheme.themeMainTextColor;
