...
- (void)setInfomodel:(MyEntrustInfoModel *)infomodel{
    ...
    [self layoutUI];
    self.symbolLabel.text = infomodel.symbol;
...
- (void)layoutUI{
    ...
    [self.statusButton setTitleColor:QDThemeManager.currentTheme.themeMainTextColor forState:UIControlStateNormal];
    
    self.timeTitle.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;
    self.entrustPriceTitle.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;
    self.entrustNumTitle.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;
    self.dealTitle.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;
    self.dealPerPriceTitle.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;
    self.dealNumTitle.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;
    self.lastLabel.textColor = QDThemeManager.currentTheme.themeDescriptionTextColor;

    self.timeData.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.ntrustPriceData.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.entrustNumData.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.dealData.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.dealPerPriceData.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.dealNumData.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.lastValueLabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
