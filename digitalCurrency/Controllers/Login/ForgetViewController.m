...
@property (weak, nonatomic) IBOutlet QMUITextField *confirmTF;
...
- (void)layoutUI{
    ...
    self.verifylabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.newpasswordlabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    self.confirflabel.textColor = QDThemeManager.currentTheme.themeTitleTextColor;
    ...
    self.confirmTF.textColor = QDThemeManager.currentTheme.themeMainTextColor;
    ...
    self.confirmTF.placeholderColor = QDThemeManager.currentTheme.themePlaceholderColor;
